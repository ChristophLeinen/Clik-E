...
class EvaluationPage2 extends StatefulWidget {
  const EvaluationPage2({super.key, required this.formId, required this.type});

  final String formId;
  final String type;

  @override
  State<EvaluationPage2> createState() => _EvaluationPageState2();
}
...
class _EvaluationPageState2 extends State<EvaluationPage2> {
  ...
  Column questionGenerator(
      Question question,
      String type,
      Function(double value) sliderChange,
      Function(double? value) radioChange,
      sliderValue) {
    Widget inputControl = SizedBox(height: 32, width: 150, child: TextField());

    if (type == "Schieberegler") {
      inputControl = SizedBox(
          width: 350,
          child: Slider(
